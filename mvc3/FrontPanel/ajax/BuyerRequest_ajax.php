                ...
                <div class="col-md-12 num">
                    <ul class="pagination justify-content-center">
                        <li class="<?php if($page == 1){ echo 'disabled'; }?> page-item">
                            <a class="page-link" onclick="showBuyerRequest(<?php echo $page-1 ; ?>)" aria-label="Previous">
                        ...
                        ?>
                        <li class=" page-item">
                            <a class="page-link <?php if($page == $i) { echo 'active'; }?>" onclick="showBuyerRequest(<?php echo $i ; ?>)"><?php echo $i ;?></a>
                        </li>
                        ...
                        <li class="<?php if($page == $total_pages){ echo 'disabled'; }?> page-item">
                            <a class="page-link" onclick="showBuyerRequest(<?php echo $page+1 ; ?>)" aria-label="Next">
