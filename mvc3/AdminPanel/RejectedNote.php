        ...
        <div class="container">
                ...
                <div class="row heading">
                    <div class="col-md-6 col-sm-6" style="padding-left: 5px">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 search-dropdown">
                                <label>Seller</label>
                                <select id="seller" onchange="showRejectedNotesList()" class="form-control customDropDown-Multiple">
                    ...
                    <div class="col-md-6 col-sm-6 text-right p-0 search-1" style="align-items: flex-end">
                        ...
                        <button class="btn btn-general" onclick="showRejectedNotesList()" role="button">Search</button>
                    </div>
                </div>

                <script type="text/javascript">
                function showRejectedNotesList(page){
                    let search_input = $("#search_input").val();
                    let search_seller = $("select#seller").val();

                    $.ajax({
                    type: "GET",
                    url: "ajax/RejectedNote_ajax.php",
                    data: {
                        page: page,
                    ...
                    success: function(data){
                        $("#rejectednote_list").html(data);
                    }
                });

                }
                $(function() {
                    showRejectedNotesList(1);
                });
            </script>

            <div id="rejectednote_list"></div>
