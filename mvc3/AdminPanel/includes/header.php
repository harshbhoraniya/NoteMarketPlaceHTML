            ...
            <div class="container p-0">
                <div class="row">
                    ...
                    <div class="col-md-4 navbar-header">
                        <a class="navbar-brand text-left" href="../FrontPanel/HomePage.php">
                    ...
                    <div class="text-right col-md-8 collapse navbar-collapse p-0" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="../AdminPanel/Dashboard.php">Dashboard</a></li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="../AdminPanel/NoteUnderReview.php">Notes Under Review</a>
                                    <a class="dropdown-item" href="../AdminPanel/PublishedNote.php">Published Notes</a>
                                    <a class="dropdown-item" href="../AdminPanel/DownloadedNote.php">Downloaded Notes</a>
                                    <a class="dropdown-item" href="../AdminPanel/RejectedNote.php">Rejected Notes</a>

                                </div>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../AdminPanel/Members.php">Members</a></li>
                            <li class="nav-item"><a class="nav-link" href="../AdminPanel/SpamReports.php">Reports</a></li>
                            <li class="nav-item dropdown">
                                <a href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false" class="nav-link nav-link-custom">
                                    Setting
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="../AdminPanel/ManageSyatemConfiguration.php">Manage System
                                        Configuration</a>
                                    <a class="dropdown-item" href="../AdminPanel/ManageAdministrator.php">Manage Administrator</a>
                                    <a class="dropdown-item" href="../AdminPanel/ManageCategory.php">Manage Category</a>
                                    <a class="dropdown-item" href="../AdminPanel/ManageType.php">Manage Type</a>
                                    <a class="dropdown-item" href="../AdminPanel/ManageCountry.php">Manage Countries</a>
                                ...
                                <div class="dropdown">
                                    <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                        ...
                                        <?php
                                            ...
                                            $total = mysqli_num_rows($select_photo);
                                            if($total != 0){
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="../AdminPanel/MyProfile.php">Update Profile</a>
