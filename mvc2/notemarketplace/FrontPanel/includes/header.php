                ...
                <div class="row">
                    ...
                    <div class="text-right col-md-9 collapse navbar-collapse p-0" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a id="a-sell" onclick="dodajAktywne(this)" class="nav-link" href="Dashboard.php">Sell Your Notes</a>
                            </li>
                            <li class="nav-item"><a id="a-buyer" onclick="dodajAktywne(this)" class="nav-link" href="BuyerRequest.php">Buyer Requests</a></li>
                            <li class="nav-item"><a id="a-faq" onclick="dodajAktywne(this)" class="nav-link" href="FAQ.php">FAQ</a></li>
                            <li class="nav-item"><a id="a-contact" onclick="dodajAktywne(this)" class="nav-link" href="ContactUs.php">Contact Us</a></li>
                            <li class="nav-item">
                                <div class="dropdown">
