                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a class="dropdown-item active" href="PublishedNote.php">Published Notes</a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Raj Shah</td>
                                    <td class="text-center td-blue">75</td>
                                ...
                                <tr>
                                    ...
                                    <td>Khyati Patel</td>
                                    <td class="text-center td-blue">30</td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                ...
                                <tr>
                                    ...
                                    <td>08-11-2020, 04:07</td>
                                    <td>Raj Shah</td>
                                    <td class="text-center td-blue">28</td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                ...
                                <tr>
                                    ...
                                    <td>Raj Shah</td>
                                    <td class="text-center td-blue">25</td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                ...
                                <tr>
                                    ...
                                    <td>Niya Patel</td>
                                    <td class="text-center td-blue">8</td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            <a href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
